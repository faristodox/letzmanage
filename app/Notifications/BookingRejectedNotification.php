...
class BookingRejectedNotification extends Notification
{
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'reason' => $this->booking->notes,
            'message' => "Your booking for \"{$this->booking->space->name}\" has been rejected.",
        ];
    }

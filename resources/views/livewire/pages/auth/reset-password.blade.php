...
<div>
    ...
    <form wire:submit="resetPassword" class="mt-8 space-y-5">
        ...
        <div>
            ...
            <x-text-input wire:model="email" id="email" class="block mt-1.5 w-full rounded-lg py-2.5" type="email" name="email" required autofocus autocomplete="username" />
        ...
        <div>
            ...
            <x-text-input wire:model="password" id="password" class="block mt-1.5 w-full rounded-lg py-2.5" type="password" name="password" required autocomplete="new-password" />

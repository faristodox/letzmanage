...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $form->title }} - {{ $organizationName }}</title>
            ...
            <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div class="text-center">
                    ...
                    <p class="mt-4 text-slate-600 max-w-xl mx-auto">
                        {{ __('Fill in the form below to submit your response.') }}
                    </p>
                </div>

                <div class="mt-12">
                    <livewire:public.form-submission :form="$form" :preview="$preview ?? false" />
                </div>
            </div>
        </main>

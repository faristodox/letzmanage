    ...
    <div x-data="{ tab: 'moduls' }">
        ...
        <div class="mb-6 flex gap-1 border-b border-slate-200">
            ...
            <button
                ...
                type="button"
                class="border-b-2 px-4 py-2.5 text-sm font-semibold transition-colors"
                :class="tab === 'naqib' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-500 hover:text-slate-700'"
            >
                {{ __('Naqib Usrah') }}
            </button>
        </div>
        ...
        <div x-show="tab === 'naqib'" x-cloak>
            <livewire:spi-members.naqib-usrah />
        </div>
    </div>
</x-app-layout>
